...
if __name__ == "__main__":
    ...
    for iteration in range(1, REPLICATIONS + 1):
        ...
        inspector_1 = Inspector(1, ["c1"], env, inspector_1_data)
        inspector_2 = Inspector(2, ["c2", "c3"], env, inspector_2_data)

        workstation_1 = Workstation(1, ["c1"], env, workstation_1_data)
        workstation_2 = Workstation(2, ["c1", "c2"], env, workstation_2_data)
        workstation_3 = Workstation(3, ["c1", "c3"], env, workstation_3_data)
